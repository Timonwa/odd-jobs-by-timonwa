...
const FEATURES: Feature[] = [
	{
		...
		body: "Your words never touch a server I own. The instant tools run entirely on your machine, and AI requests go straight to Google — never stored, never used for training. Your drafts stay yours.",
		big: true,
	},
	{
		icon: SparklesIcon,
