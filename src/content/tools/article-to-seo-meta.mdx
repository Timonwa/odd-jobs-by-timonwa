export const faq = [
	...
	},
	{
		...
		answer:
			"No. Your article is sent to the model only to generate the metadata for that single request; it isn't saved on our servers or used for training. If you add your own key, requests go straight to Google's Gemini with it.",
	},
	{
